...
AARCH64_LABELS = {
    ...
    # ARM SMC call forwarding
    Sel4Label.ARMSMCCall: 40,
    # ARM Page table
    Sel4Label.ARMPageTableMap: 41,
    Sel4Label.ARMPageTableUnmap: 42,
    # ARM Page
    Sel4Label.ARMPageMap: 43,
    Sel4Label.ARMPageUnmap: 44,
    Sel4Label.ARMPageClean_Data: 45,
    Sel4Label.ARMPageInvalidate_Data: 46,
    Sel4Label.ARMPageCleanInvalidate_Data: 47,
    Sel4Label.ARMPageUnify_Instruction: 48,
    Sel4Label.ARMPageGetAddress: 49,
    # ARM Asid
    Sel4Label.ARMASIDControlMakePool: 50,
    Sel4Label.ARMASIDPoolAssign: 51,
    # ARM IRQ
...
# @ivanv: PA_40 and PA_44 are the same now...
