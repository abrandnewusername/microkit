...
from microkit.util import (MemoryRegion)
from microkit.sysxml import (ProtectionDomain)
from microkit.sysxml import (SysMap, SysMemoryRegion)
...
def register_sizes_aarch64() -> None:
    register_object_sizes(aarch64_sizes)

def register_sizes_x86_64() -> None:
    register_object_sizes(x86_64_sizes)
